...
int
ObjID_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
ObjID_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
ObjID_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	ObjID_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
ObjID_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
ObjID_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
ObjID_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
ObjID_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
ObjID_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static ber_tlv_tag_t asn_DEF_ObjID_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (6 << 2))
};
asn_TYPE_descriptor_t asn_DEF_ObjID = {
	"ObjID",
	"ObjID",
	ObjID_free,
	ObjID_print,
	...
	asn_DEF_ObjID_tags_1,
	sizeof(asn_DEF_ObjID_tags_1)
		/sizeof(asn_DEF_ObjID_tags_1[0]), /* 1 */
	asn_DEF_ObjID_tags_1,	/* Same as above */
	sizeof(asn_DEF_ObjID_tags_1)
		/sizeof(asn_DEF_ObjID_tags_1[0]), /* 1 */
